...
import AnimatedSection from "@/components/AnimatedSection";
import aboutImage from "@/assets/About.jpeg"; // ✅ your image
...
const sandalwoodBenefits = [
  {
    icon: Sprout,
    title: "Dual Investment Advantage",
    desc: "Land appreciation plus plantation income.",
  },
  {
    icon: TrendingUp,
    title: "Long-Term Wealth Creation",
    desc: "Red Sandalwood grows in value over decades.",
  },
  {
    icon: Shield,
    title: "Safe Tangible Asset",
    desc: "Real estate backed by a living, growing resource.",
  },
  {
    icon: Users,
    title: "Future Security",
    desc: "Build a legacy for your family and generations to come.",
  },
];
    ...
    <>
        ...
        <div className="container-main text-center max-w-3xl mx-auto">
          <AnimatedSection>
            <h1 className="text-3xl md:text-5xl font-display font-bold mb-4">
              About Viswasri Projects
            </h1>
            <p className="text-lg opacity-80">
              Smart Land Investment. Secure Future. Growing Wealth.
            </p>
          </AnimatedSection>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <div className="flex items-start gap-3">
                  <Landmark className="h-5 w-5 text-leaf mt-1 shrink-0" />
                  <p>
                    At Viswasri Projects, we transform middle-class families
                    into financially strong and asset-rich households through
                    premium land investments combined with high-value Red
                ...
                <div className="flex items-start gap-3">
                  <TreePine className="h-5 w-5 text-leaf mt-1 shrink-0" />
                  <p>
                    We integrate strategic land development with sustainable
                    agricultural plantation value, offering transparent
                    documentation and truly affordable investment
                    opportunities.
                  </p>
                </div>
              </div>
        ...
        <div className="container-main grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
          <AnimatedSection>
            <div className="bg-card rounded-xl p-8 shadow-card h-full">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To make every middle-class family rich through smart land
                investments backed by sustainable plantation growth.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.15}>
            <div className="bg-card rounded-xl p-8 shadow-card h-full">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To transform middle-class families into financially strong and
                asset-rich households through smart, secure, and sustainable
                land investments.
              </p>
            </div>
          </AnimatedSection>
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="container-main max-w-5xl">
          <AnimatedSection>
            <h2 className="text-3xl font-display font-bold mb-10 text-center">
              Why Choose Plots with Red Sandalwood
            </h2>
          </AnimatedSection>
